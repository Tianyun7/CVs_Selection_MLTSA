    ...
    with open(filename, "rb") as fr:
        try:
            while True:
                ...
                #print(int(frames*(1-percent_end)))
                #print(int(frames))
...
Y = []
AnsList = []
# for x, name in enumerate(traj_order): #CHANGE THIS WHEN IN CLUSTER WITH THE REAL DATA
...
def train_run(R):
    ...
    infile = open("results/GBDT_res_mixed_d{}_{}_test.bin".format(dataset, R), "wb")
